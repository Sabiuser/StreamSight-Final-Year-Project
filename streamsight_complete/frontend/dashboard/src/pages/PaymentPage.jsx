...
export default function PaymentPage() {
  ...
  // ── CHANGED: cartItems is now state so qty changes trigger re-renders ──
  const [cartItems, setCartItems] = useState(
    location.state?.cartItems || (product ? [{ ...product, qty: 1 }] : [])
  );
  ...
  // ── CHANGED: quantity change handler — decrease to 1 removes, at 1 deletes ──
  const changeQty = (id, delta) => {
    setCartItems((prev) => {
      return prev
        .map((item) =>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} lg={5}>
            ...
            >
              ...
              {/* ── CHANGED: Cart items with quantity controls ── */}
              <Box sx={{ px: 3, py: 2, maxHeight: 320, overflowY: "auto" }}>
                {cartItems.length === 0 ? (
                  <Typography
                    sx={{
                      color: "#94a3b8",
                  ...
                  cartItems.map((item) => (
                    ...
                    >
                      ...
                      <Box flex={1} minWidth={0}>
                        ...
                        <Typography
                          sx={{ color: "#94a3b8", fontSize: "0.72rem", mb: 0.8 }}
                        >
                        ...
                        <Box display="flex" alignItems="center" gap={0.5}>
                          <IconButton
                            ...
                            sx={{
                              ...
                              borderRadius: 1.5,
                              borderColor:
                                item.qty === 1 ? "#fca5a5" : "#e2e8f0",
                              color: item.qty === 1 ? "#ef4444" : "#475569",
                              background:
                                item.qty === 1 ? "#fef2f2" : "#f8fafc",
                              "&:hover": {
                                background:
                                  item.qty === 1 ? "#fee2e2" : "#f1f5f9",
                              },
                              p: 0,
                            }}
                          >
